            ...
            <fieldset>
                <div class="form-group">
                    <div class="col-lg-10">
                        ...
                        <?php echo $signInForm->render('email'); ?>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-10">
                        ...
                        <?php echo $signInForm->render('password'); ?>
        ...
        <form role="form" class="form-horizontal" method="POST" action="/authenticate/sign-up">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    ...
                    <?php echo $signUpForm->render('email'); ?>
                </div>
                <div class="col-lg-10">
                    <label class="control-label">Username:</label>
                    <?php echo $signUpForm->render('username'); ?>
                </div>
                <div class="col-lg-10">
                    <label class="control-label">Password:</label>
                    <?php echo $signUpForm->render('password'); ?>
                </div>
